...
public class MainPage {
    ...
    private final By accordionHeaders = By.className("accordion__heading"); // Заголовок раскрывающегося блока
    private final By accordionItems = By.xpath(".//div[@class='accordion__panel']/p"); // Абзац в раскрывающемся блоке
    private final By orderButtonHeader = By.xpath(".//div[starts-with(@class, 'Header_Nav')]//button[starts-with(@class, 'Button_Button')]"); // Кнопка оформления заказа в шапке сайта
    private final By orderButtonBody = By.xpath(".//div[starts-with(@class, 'Home_RoadMap')]//button[starts-with(@class, 'Button_Button')]"); // Кнопка оформления заказа на странице сайта
